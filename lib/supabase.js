...
// Replace with real Supabase client once you add your keys to .env

const MOCK_MODE = !process.env.SUPABASE_URL || process.env.SUPABASE_URL.includes('your-project');
