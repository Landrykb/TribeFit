...
const translations = {
  en: {
    ...
    skip_messages: {
      ...
      couch_potato: '{name} chose the couch over gains!  Money over muscle today!',
      ...
      motivation: '{name}\'s motivation went on vacation!  But their money stayed to skip workouts!',
      ...
      ad_marathon: '{name} is marathon-watching ads instead of marathon-training!  {count} skips this week!',
    ...
    equipment_request: 'Equipment request submitted for tribe voting! ',
    donation_request: 'Donation request submitted for tribe voting! ',
    ...
    vote_success: 'Vote {vote} successful! ',
  ...
  fr: {
    ...
    skip_messages: {
      ...
      couch_potato: '{name} a choisi le canapé plutôt que les gains!  L\'argent avant les muscles aujourd\'hui!',
      ...
      motivation: 'La motivation de {name} est partie en vacances!  L\'entraînement d\'aujourd\'hui sponsorisé par son portefeuille!',
      ...
      ad_marathon: '{name} fait un marathon de pubs au lieu de marathon d\'entraînement!  {count} évitements cette semaine!',
    ...
    equipment_request: 'Demande d\'équipement soumise au vote de la tribu! ',
    ...
    vote_success: 'Vote {vote} réussi! ',
    failed_vote: 'Échec du vote',
    failed_donation_request: 'Échec de la demande de don',
    donation_request: 'Demande de don soumise au vote de la tribu! ',
  ...
  ja: {
    ...
    skip_messages: {
      ...
      couch_potato: '{name}筋肉よりソファを選んだ!  今日はお金が筋肉より大事!',
      ...
      motivation: '{name}のやる気がバカンスに行った!  今日のワークアウトは財布がスポンサー!',
      ...
      ad_marathon: '{name}トレーニングマラソンの代わりに広告マラソンをしてる!  今週{count}回スキップ!',
    ...
    vote_approve: '承認投票',
    vote_reject: '拒否投票',
    equipment_request: '器具リクエストをトライブ投票に提出しました！',
    ...
    vote_success: '投票{vote}が成功しました！',
    failed_vote: '投票に失敗しました',
    failed_donation_request: '寄付リクエストの送信に失敗しました',
    donation_request: '寄付リクエストをトライブ投票に提出しました！',
