  ...
  static getUpgradeRewards() {
    return {
      ...
      economicPerks: [
        ...
        '️ Democratic voting on vault distribution',
      ...
      // Social & Governance
      socialPerks: [
        '️ Vote on equipment & donation requests',
      ...
      statusPerks: [
        ...
        '️ Tribe-exclusive achievement badges',
      ...
      capacityPerks: [
        ...
        '️ Tribe vs Tribe competitions (5-10 TC = ¥500-1,000)',
