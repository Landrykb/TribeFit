...
export class FeatureFlags {
  ...
  static get TRIBE_UPGRADE() {
    return this.TRIBE_UPGRADE_BY_SIZE;
  }
  ...
  // Progression rewards flag (default off)
  static get PROGRESSION_REWARDS() {
    return (typeof window !== 'undefined'
      ? process.env.NEXT_PUBLIC_FEATURE_PROGRESSION_REWARDS === 'true'
      : process.env.FEATURE_PROGRESSION_REWARDS === 'true');
  }
  ...
  // Deal Economics Constants (Yen-Based: 1 TC = 100 yen)
  static get DEAL_SKIP_FEE_TC() {
    return parseInt(process.env.DEAL_SKIP_FEE_TC || '2'); // Squad: 2 TC (200 yen), Tribe: 1 TC (100 yen)
  }
